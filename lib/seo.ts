...
const defaultSEO = {
	...
	titleTemplate: '%s | Rohit Singh Rawat',
	description:
		'Software Engineer specializing in full-stack development, React, Next.js, and modern web technologies. Building innovative digital experiences.',
	keywords: [
		'Rohit Singh Rawat',
		'Software Engineer',
	...
	url: process.env.NEXT_PUBLIC_URL || 'https://rohitsinghrawat.com',
	type: 'website' as const,
	author: 'Rohit Singh Rawat',
	twitter: '@Spacing_Whale',
	locale: 'en_US',
	siteName: 'Rohit Singh Rawat',
};
